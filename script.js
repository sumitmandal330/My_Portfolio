...
document
  ...
  .addEventListener("submit", function (e) {
    ...
    emailjs.sendForm("service_xp6ns2r", "template_07jt7ao", form).then(
      function () {
...
document
  .querySelectorAll(".certificate-popup .close-btn")
  .forEach((closeBtn) => {
...
const projectData = {
  ...
  4: {
    img: ["image/Hostel Management system/image-39.webp"],
...
toggleBtn.addEventListener("click", () => {
  ...
  toggleBtn.textContent = modalDescription.classList.contains("short")
    ? "See more"
    : "See less";
});
